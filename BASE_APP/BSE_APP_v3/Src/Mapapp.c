...
static const ST_PARAM_ROW tzApp[appEnd-appBeg] = {
		...
		{ appEthIpLocal,         lenEthIpLocal,        "192.168.001.143" },       // Local Ip Address
		{ appEthPort,            lenEthPort,           "8007" },                  // Port number
		...
		{ appGprsPort,           lenGprsPort,          "8044" },                  // Port number
		...
		{ appPppIpLocal,         lenPppIpLocal,        "192.168.001.143" },           // Local Ip Address
		{ appPppPort,            lenPppPort,           "8044" },                  // Port number
		{ appCommRoute,          3,                    "G" },
		{ appCommSSL,            3,                    "X" },
		{ appNII,                lenNii,               "0003" },
		{ apptpduHead,           2,                    "60" },
